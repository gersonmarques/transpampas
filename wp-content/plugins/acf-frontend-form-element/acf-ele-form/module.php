...
class ACFEF_Module extends Module
{
    ...
    public function acfef_edit_mode_scripts()
    {
        ...
        if ( get_field( 'acfef_payments_active', 'options' ) && \Elementor\Plugin::$instance->preview->is_preview_mode() ) {
            wp_enqueue_style(
                'acfef-card',
    ...
    public function acfef_icon_file()
    {
        ...
        wp_enqueue_style(
            'acfef-editor',
            ACFEF_URL . 'acf-ele-form/assets/css/editor.min.css',
            array(),
            '1.0.10'
        );
    }
    ...
    public function __construct()
    {
        ...
        add_action( 'wp_footer', [ $this, 'acfef_elementor_preview' ], 9 );
        add_action( 'elementor/frontend/before_enqueue_styles', [ $this, 'acfef_enqueue_scripts' ] );
