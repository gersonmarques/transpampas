...
class acfef_recaptcha extends acf_field{
    
    function __construct(){
        
        $this->name = 'acfef_recaptcha';
    ...
    function render_field($field){
        ...
        // Site key
        $site_key = acf_get_setting('acfef/field/recaptcha/site_key', $field['site_key']);
        
        // Version
        $field['version'] = acf_get_setting('acfef/field/recaptcha/version', $field['version']);
        ...
        if($field['version'] === 'v2'){ ?>
            ...
            <?php
            // Theme & Size
            $field['v2_theme'] = acf_get_setting('acfef/field/recaptcha/v2/theme', $field['v2_theme']);
            $field['v2_size'] = acf_get_setting('acfef/field/recaptcha/v2/size', $field['v2_size']);
            
            $wrapper = array(
                'class'         => 'acf-input-wrap acfef-field-recaptcha',
            ...
            <script src="https://www.google.com/recaptcha/api.js?onload=acfef_recaptcha&render=explicit" async defer></script>
        ...
        elseif($field['version'] === 'v3'){
            ...
            // Hide logo
            $field['v3_hide_logo'] = acf_get_setting('acfef/field/recaptcha/v3/hide_logo', $field['v3_hide_logo']);
            
            $wrapper = array(
                'class'         => 'acf-input-wrap acfef-recaptcha',
                'data-site-key' => $site_key,
                'data-version'  => 'v3',
            );
            ...
            <script src="https://www.google.com/recaptcha/api.js?render=<?php echo $site_key; ?>&onload=acfef_recaptcha" async defer></script>
    ...
    function validate_value($valid, $value, $field, $input){
        ...
        elseif(!wp_doing_ajax()){
            ...
            // Success
                ...
                // Secret key
                $secret_key = acf_get_setting('acfef/field/recaptcha/secret_key', $field['secret_key']);
...
// initialize
acf_register_field_type('acfef_recaptcha');